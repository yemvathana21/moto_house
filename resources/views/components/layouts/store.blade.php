    ...
    <header class="bg-white border-b border-gray-100 sticky top-0 z-50 shadow-sm" x-data="{ mobileOpen: false, searchOpen: false, q: '', results: [], timer: null }"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="hidden md:flex items-center mx-4" x-data="{ q: '', results: [], open: false, timer: null, showInput: false }"
                     @click.outside="if (!open && !showInput) return; open = false; showInput = false">
                    ...
                    <div x-show="showInput" class="relative w-72" x-cloak>
                    ...
                    <div x-show="open" class="absolute top-full mt-2 w-72 bg-white rounded-xl shadow-lg border border-gray-100 py-2 z-50 max-h-80 overflow-y-auto" x-cloak>
